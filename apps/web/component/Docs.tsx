  ...
  return (
    <>
        <h1 className="text-2xl font-bold mb-6">
          Eventually Consistent Form — Test Guide
        </h1>

        <section className="space-y-4 text-sm">
          
          <div>
            <h2 className="font-semibold text-lg">What This Demo Shows</h2>
            <ul className="list-disc pl-5 space-y-1">
              <li>Dynamic validation rules fetched from server</li>
              <li>Clear separation of client vs server errors</li>
              <li>Prevention of duplicate submissions</li>
              <li>Loading & submission states</li>
              <li>No loss of user input on failure</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ol className="list-decimal pl-5 space-y-2">
              ...
              <li>
                <b>Loading State</b>  
                Notice the submit button disables during request.
              </li>
            </ol>
          </div>
